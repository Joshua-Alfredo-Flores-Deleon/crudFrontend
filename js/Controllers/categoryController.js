...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    loadCategories(); //Despuues de cargar las constantes, cargamos los registros

    btnAdd.addEventListener("click", ()=>{
        form.reset();
        form.categoryId.value = "";
        lbModal.textContend = "Agregar categoria";
        modal.show();
    });
    ...
    async function loadCategories() {
        try {
            ...
            //Verifica si no hay categporias registradas
            ...
            categories.forEach((cat)=>{
                ...
                tr.querySelector(".edit-btn").addEventListener("click", ()=>{
                    ...
                    lbModal.textContend = "Editar Categoria";
            ...
            console.error("Error cargando categoriaqs: ", err);
        }
    }
});